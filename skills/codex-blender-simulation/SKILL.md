...
Use `codex-blender-background-jobs` with `BAKE_POINT_CACHES` for expensive baking. Query the terminal receipt, reopen the baked project, and check physical measurements plus visual behavior. Cache paths must stay inside the job directory.
