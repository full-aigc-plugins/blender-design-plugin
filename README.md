...
- **Managed** registers 192 commands: 175 at L3, 3 Windows-verified recovery and Rigify commands at L4, 14 at L1, and 0 at L2, across 35 domains, routed through 23 of the 29 bundled Skills.
- **Connector** adds the 5 optional `official_uploader.*` commands: 197 commands, 175 at L3, 3 at L4, 19 at L1, and 0 at L2, across 36 domains, routed through 24 Skills.
...
|---|---|---|---|---|
| `0.3.0` | Codex CLI or ChatGPT desktop app | Blender 4.2.23 baseline in CI, release matrix in `config/blender-release-matrix.json` | macOS Apple Silicon (UDS transport) | Verified |
| `0.3.0` | Codex CLI or ChatGPT desktop app | same | Windows x64 (Named Pipe transport) | `NOT_RUN` — requires a Windows host |
| `0.3.0` | Codex CLI or ChatGPT desktop app | same | Linux headless (tokenized loopback TCP) | Experimental, not a release gate |
...
- **Connector** adds the 5 optional `official_uploader.*` commands: 197 commands, 175 at L3, 3 at L4, 19 at L1, across 36 domains, routed through 24 Skills.
