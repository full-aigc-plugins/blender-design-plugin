...
- **非侵入模式（Managed）** 注册 165 条命令：其中 154 条 L3、3 条经 Windows 验证的恢复与 Rigify 命令达到 L4、8 条 L1、0 条 L2，横跨 35 个域，路由到 32 个内置 Skill 中的 23 个。
- **Connector 模式** 额外加入 5 条可选 `official_uploader.*` 命令：合计 170 条命令，154 条 L3、3 条 L4、13 条 L1、0 条 L2，横跨 36 个域，路由到 24 个 Skill。
