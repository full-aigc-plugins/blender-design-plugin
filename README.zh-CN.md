...
- **Managed** 共注册 183 条命令：166 条 L3、3 条恢复/Rigify 工具通过 Windows 达到 L4、14 条 L1，横跨 35 个域，路由到 23 个 Skill。
- **Connector** 在此之上增加 5 条可选 `official_uploader.*` 命令：188 条命令、166 条 L3、3 条 L4、19 条 L1，横跨 36 个域，路由到 24 个 Skill。
