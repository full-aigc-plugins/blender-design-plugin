...
description: Effects and editorial specialist covering hair curves grooming with per-operation geometric effects, cloth/soft-body/rigid/smoke simulation with cache staleness detection, Grease Pencil 3 layers and interpolation, and VSE sequencing with transform/crop/proxy controls.
displayName:
  en: "Blender FX & Editorial Specialist"
  zh: "Blender 特效剪辑专家"
profession:
  en: "FX / Editorial Artist"
  zh: "特效剪辑师"
maxTurns: 120
---
