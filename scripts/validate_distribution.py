...
VERSION_PATTERN = re.compile(r"^0\.13\.1(?:\+[0-9A-Za-z.-]+)?$")
REQUIRED_FILES = (
    "README.md",
    "README.zh-CN.md",
    "LICENSE",
...
EXPECTED_SOURCE = {"source": "url", "url": REPO_URL + ".git", "ref": "v0.13.1"}
...
def validate(root: Path) -> list[str]:
    ...
    if VERSION_PATTERN.fullmatch(manifest.get("version") or "") is None:
        errors.append(
            "release version must be 0.13.1, optionally with a +build cachebuster"
        )
